//  ** Modified to support custom emojis **
// 
...
/// one of its ancestors to be a [Material] widget. When the [EmojiTextField] is
/// tapped an ink splash that paints on the material is triggered, see
/// [ThemeData.splashFactory].
///
/// To integrate the [EmojiTextField] into a [Form] with other [FormField] widgets,
/// consider using [TextFormField].
///
/// {@tool sample}
/// This example shows how to create a [EmojiTextField] that will obscure input. The
...
///  * [EditableEmojiText], which is the raw text editing control at the heart of a
///    [EmojiTextField]. The [EditableEmojiText] widget is rarely used directly unless
...
class EmojiTextField extends StatefulWidget {
  ...
  ///
  /// This widget builds an [EditableEmojiText] and will ensure that the keyboard is
...
class _EmojiTextFieldState extends State<EmojiTextField> with AutomaticKeepAliveClientMixin {
  final GlobalKey<EditableEmojiTextState> _editableTextKey = GlobalKey<EditableEmojiTextState>();

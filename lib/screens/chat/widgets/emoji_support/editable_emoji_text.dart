...
///
/// Rather than using this widget directly, consider using [EmojiTextField], which
...
/// [EmojiTextField] or [CupertinoTextField]. For custom selection behavior, call
/// methods such as [RenderEditable.selectPosition],
/// [RenderEditable.selectWord], etc. programmatically.
///
/// See also:
///
///  * [EmojiTextField], which is a full-featured, material-design text input field
...
class EditableEmojiText extends StatefulWidget {
  ...
  ///
  /// The [EditableEmojiText] widget used on its own will not trigger the display
  /// of the selection toolbar by itself. The toolbar is shown by calling
  /// [EditableTextState.showToolbar] in response to an appropriate user event.
  ///
  /// See also:
  ///
  ///  * [CupertinoTextField], which wraps an [EditableEmojiText] and which shows the
  ///    selection toolbar upon user events that are appropriate on the iOS
  ///    platform.
  ///  * [EmojiTextField], a Material Design themed wrapper of [EditableEmojiText], which
